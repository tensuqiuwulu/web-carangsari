            ...
            <form action="{{ route('admin.berita.store') }}">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <input type="text" class="form-control mb-3" name="judul" value="{{$peninggalanKuno->judul}}">
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-10">
                                <img src="{{ asset('storage/peninggalan_kuno/' . $peninggalanKuno->foto) }}" class="img-fluid" alt="">
                            </div>
                        </div>
                    </div>
                </div>
